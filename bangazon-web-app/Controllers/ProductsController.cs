...
namespace Bangazon.Controllers
{
    public class ProductsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("ProductId,Quantity,DateCreated,Description,Title,Price,ProductTypeId,LocalDelivery,City,Image")] Product product)
        {
